...
parser.add_argument('--use_char_embed', action='store_true', help="Character-level embedding")
parser.add_argument('--use_pre_trained', action='store_true', help="Whether to use pre-trained word embedding")
